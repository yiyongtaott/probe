...
/// 设备状态跟踪 — 改编自原 probe 项目 ProbeDeviceState
/// 仅写入本地文件，不上报后端（design2.md）
object TulpaDeviceState {
    const val DEVICE_STATE_FILE = "tulpa_device_state.json"
    const val SCREEN_OFF_WINDOW = "系统息屏"
    const val LOCKED_WINDOW = "系统锁屏"
    private const val TAG = "TulpaDeviceState"
    ...
    fun start(context: Context) {
        ...
        try {
            ...
            Log.i(TAG, "device state receiver registered")
        } catch (e: Exception) {
